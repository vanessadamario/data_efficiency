...
def main():
    ...
    # save_id_path = '/om5/user/vanessad/mnist_natural/dim_200'
    save_id_path = '/om5/user/vanessad/mnist_natural_0918'
    print('start', start_)
    print('end', end_)
    ...
    # path_save_train = '/om5/user/vanessad/mnist_natural/dim_%i/train' % new_mnist_dims
    # path_save_test = '/om5/user/vanessad/mnist_natural/dim_%i/test' % new_mnist_dims
    path_save_train = '/om5/user/vanessad/mnist_natural_0918/dim_%i/train' % new_mnist_dims
    path_save_test = '/om5/user/vanessad/mnist_natural_0918/dim_%i/test' % new_mnist_dims
    ...
    if not bool_test:
        ...
        for id_tr_, (mnist_sample_tr, id_place_) in enumerate(zip(x_train_mnist[start_:end_],
            ...
            image_ = image.copy()
            image_[mesh_y, mesh_x] = mnist_sample_tr
        ...
        for id_ts_, (mnist_sample_ts, id_place_) in enumerate(zip(x_test_mnist[start_:end_],
            ...
            print(np.max(image))
            image_ = image.copy() / np.max(image)
            image_[mesh_y, mesh_x] = mnist_sample_ts
